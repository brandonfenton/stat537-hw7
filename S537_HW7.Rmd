...
The G1 Index is maximized by the two cluster solution, disagreeing with our decision based on the dendrogram. The two cluster solution does the best job of partitioning . The index decreases monotonically as the number of clusters increases. This suggests that the data may be best described by one single cluster, but we cannot include the one cluster solution in the comparison because G1 Index is undefined for one cluster.
...
ESS decreases each time the number of clusters is increased. The elbow of the plot occurs at 3 three clusters, suggesting that 
